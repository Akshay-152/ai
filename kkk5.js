...
renderMessageContent(content) {
    ...
    return `
      <div class="image-message">
        <img src="${content}" alt="Image" style="max-width: 100%; border-radius: 0.5rem;" />
        <a href="${content}" download class="btn btn-secondary" style="margin-top: 0.5rem; display: inline-block;">
